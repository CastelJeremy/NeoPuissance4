    ...
    isConnected(playerId) {
        ...
        for (let j = 0; j < matrix[0].length - 3; j++)
            for (let i = 0; i < matrix.length; i++)
                if (
                    matrix[i][j] == playerId &&
                    matrix[i][j + 1] == playerId &&
                    matrix[i][j + 2] == playerId &&
                    matrix[i][j + 3] == playerId
                )
                    return true;
        ...
        for (let i = 0; i < matrix.length - 3; i++)
            for (let j = 0; j < matrix[i].length; j++)
                if (
                    matrix[i][j] == playerId &&
                    matrix[i + 1][j] == playerId &&
                    matrix[i + 2][j] == playerId &&
                    matrix[i + 3][j] == playerId
                )
                    return true;
        ...
        for (let i = 3; i < matrix.length; i++)
            for (let j = 0; j < matrix[i].length - 3; j++)
                if (
                    matrix[i][j] == playerId &&
                    matrix[i - 1][j + 1] == playerId &&
                    matrix[i - 2][j + 2] == playerId &&
                    matrix[i - 3][j + 3] == playerId
                )
                    return true;
